...
app.post('/tenant/pay-now/process', isTenant, async (req, res) => {
  ...
  successRedirectUrl: 'https://goyal-production.up.railway.app/tenant/pay-now/success',
  failureRedirectUrl: 'https://goyal-production.up.railway.app/tenant/pay-now/failure',
